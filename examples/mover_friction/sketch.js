...
function setup() {
    ...
    // movers[0] = new p5mimicry.Mover(width/2, 10, 40);
    // movers[1] = new p5mimicry.Mover(20, 10, 40);

    movers = [...new Array(50).fill(null)].map(item => new p5mimicry.Mover(random(width), 10, 30, {maxSpeed:4}))
